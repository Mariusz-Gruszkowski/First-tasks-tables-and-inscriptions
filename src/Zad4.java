/*
Write a program that considers a square array with elements that can be any real numbers.
The size of the array is randomized from the range <5, 10>. Check for which diagonal in this array the sum of the elements under the diagonal
is greater than the sum of the elements above the diagonal.
