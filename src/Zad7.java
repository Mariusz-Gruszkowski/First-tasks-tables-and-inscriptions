/*
Write a program that randomizes the size of a one-dimensional array of integers between <10, 20>.
  Then you randomize the first two elements of the array from <20, 100>. Each subsequent element of the array is
   least common multiple of the previous two array elements.
   Check if the array contains any duplicates and provide their values.
